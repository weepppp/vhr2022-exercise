...
//                            .enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("D:\\testtesttesttesttesttesttesttesttesttest\\vhr\\vhr-framework\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.qfedu.vhr") // 设置父包名
                            .moduleName("framework") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\testtesttesttesttesttesttesttesttesttest\\vhr\\vhr-framework\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
